...
main(int argc, char *argv[])
{
  ...
  60:	c7 44 24 04 5b 09 00 	movl   $0x95b,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 08 05 00 00       	call   57c <printf>
  exit();
...
ps() {
 ...
 2ec:	c7 44 24 04 6f 09 00 	movl   $0x96f,0x4(%esp)
 2f3:	00 
 2f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 2fb:	e8 7c 02 00 00       	call   57c <printf>
  getpinfo(&pstat);
 ...
 3a8:	c7 44 24 04 88 09 00 	movl   $0x988,0x4(%esp)
 3af:	00 
 3b0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 3b7:	e8 c0 01 00 00       	call   57c <printf>
      i++;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 515:	0f b6 80 14 0c 00 00 	movzbl 0xc14(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 672:	75 09                	jne    67d <printf+0x101>
          s = "(null)";
 674:	c7 45 f4 98 09 00 00 	movl   $0x998,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 73e:	a1 30 0c 00 00       	mov    0xc30,%eax
 ...
 809:	a3 30 0c 00 00       	mov    %eax,0xc30
}
 80e:	c9                   	leave  
 80f:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 82f:	e8 48 fc ff ff       	call   47c <sbrk>
 ...
 85c:	e8 ce fe ff ff       	call   72f <free>
  return freep;
 861:	a1 30 0c 00 00       	mov    0xc30,%eax
}
 866:	c9                   	leave  
 867:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 87a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 87d:	a1 30 0c 00 00       	mov    0xc30,%eax
 882:	89 45 f0             	mov    %eax,-0x10(%ebp)
 885:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 889:	75 23                	jne    8ae <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 88b:	c7 45 f0 28 0c 00 00 	movl   $0xc28,-0x10(%ebp)
 892:	8b 45 f0             	mov    -0x10(%ebp),%eax
 895:	a3 30 0c 00 00       	mov    %eax,0xc30
 89a:	a1 30 0c 00 00       	mov    0xc30,%eax
 89f:	a3 28 0c 00 00       	mov    %eax,0xc28
    base.s.size = 0;
 8a4:	c7 05 2c 0c 00 00 00 	movl   $0x0,0xc2c
 8ab:	00 00 00 
  }
 ...
 901:	a3 30 0c 00 00       	mov    %eax,0xc30
      return (void*)(p + 1);
 ...
 90c:	eb 38                	jmp    946 <malloc+0xde>
    ...
    if(p == freep)
 90e:	a1 30 0c 00 00       	mov    0xc30,%eax
