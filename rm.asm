...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 72 09 00 	movl   $0x972,0x4(%esp)
  6d:	00 
...
ps() {
 ...
 302:	c7 44 24 04 8b 09 00 	movl   $0x98b,0x4(%esp)
 309:	00 
 ...
 3be:	c7 44 24 04 a4 09 00 	movl   $0x9a4,0x4(%esp)
 3c5:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 52b:	0f b6 80 30 0c 00 00 	movzbl 0xc30(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 688:	75 09                	jne    693 <printf+0x101>
          s = "(null)";
 68a:	c7 45 f4 b4 09 00 00 	movl   $0x9b4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 754:	a1 4c 0c 00 00       	mov    0xc4c,%eax
 ...
 81f:	a3 4c 0c 00 00       	mov    %eax,0xc4c
}
 824:	c9                   	leave  
 825:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 872:	e8 ce fe ff ff       	call   745 <free>
  return freep;
 877:	a1 4c 0c 00 00       	mov    0xc4c,%eax
}
 87c:	c9                   	leave  
 87d:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 890:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 893:	a1 4c 0c 00 00       	mov    0xc4c,%eax
 898:	89 45 f0             	mov    %eax,-0x10(%ebp)
 89b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 89f:	75 23                	jne    8c4 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8a1:	c7 45 f0 44 0c 00 00 	movl   $0xc44,-0x10(%ebp)
 8a8:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8ab:	a3 4c 0c 00 00       	mov    %eax,0xc4c
 8b0:	a1 4c 0c 00 00       	mov    0xc4c,%eax
 8b5:	a3 44 0c 00 00       	mov    %eax,0xc44
    base.s.size = 0;
 8ba:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 8c1:	00 00 00 
  }
 ...
 917:	a3 4c 0c 00 00       	mov    %eax,0xc4c
      return (void*)(p + 1);
 ...
 922:	eb 38                	jmp    95c <malloc+0xde>
    ...
    if(p == freep)
 924:	a1 4c 0c 00 00       	mov    0xc4c,%eax
