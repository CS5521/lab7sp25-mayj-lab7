...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 14 66 00 00       	mov    0x6614,%eax
       b:	c7 44 24 04 72 46 00 	movl   $0x4672,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 72 42 00 00       	call   428d <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 7d 46 00 00 	movl   $0x467d,(%esp)
      22:	e8 3e 41 00 00       	call   4165 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 14 66 00 00       	mov    0x6614,%eax
      30:	c7 44 24 04 85 46 00 	movl   $0x4685,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 4d 42 00 00       	call   428d <printf>
    exit();
      40:	e8 b8 40 00 00       	call   40fd <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 7d 46 00 00 	movl   $0x467d,(%esp)
      4c:	e8 1c 41 00 00       	call   416d <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 14 66 00 00       	mov    0x6614,%eax
      5a:	c7 44 24 04 93 46 00 	movl   $0x4693,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 23 42 00 00       	call   428d <printf>
    exit();
      6a:	e8 8e 40 00 00       	call   40fd <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 a9 46 00 00 	movl   $0x46a9,(%esp)
      76:	e8 d2 40 00 00       	call   414d <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 14 66 00 00       	mov    0x6614,%eax
      84:	c7 44 24 04 b4 46 00 	movl   $0x46b4,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 f9 41 00 00       	call   428d <printf>
    exit();
      94:	e8 64 40 00 00       	call   40fd <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 ce 46 00 00 	movl   $0x46ce,(%esp)
      a0:	e8 c8 40 00 00       	call   416d <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 14 66 00 00       	mov    0x6614,%eax
      ae:	c7 44 24 04 d0 46 00 	movl   $0x46d0,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 cf 41 00 00       	call   428d <printf>
    exit();
      be:	e8 3a 40 00 00       	call   40fd <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 14 66 00 00       	mov    0x6614,%eax
      c8:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 b5 41 00 00       	call   428d <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 14 66 00 00       	mov    0x6614,%eax
      e5:	c7 44 24 04 ee 46 00 	movl   $0x46ee,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 98 41 00 00       	call   428d <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 14 66 00 00       	mov    0x6614,%eax
     108:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 75 41 00 00       	call   428d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 7d 46 00 00 	movl   $0x467d,(%esp)
     12e:	e8 32 40 00 00       	call   4165 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 14 66 00 00       	mov    0x6614,%eax
     13c:	c7 44 24 04 85 46 00 	movl   $0x4685,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 41 41 00 00       	call   428d <printf>
      exit();
     14c:	e8 ac 3f 00 00       	call   40fd <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 7d 46 00 00 	movl   $0x467d,(%esp)
     158:	e8 10 40 00 00       	call   416d <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 14 66 00 00       	mov    0x6614,%eax
     166:	c7 44 24 04 0a 47 00 	movl   $0x470a,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 17 41 00 00       	call   428d <printf>
      exit();
     176:	e8 82 3f 00 00       	call   40fd <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 a9 46 00 00 	movl   $0x46a9,(%esp)
     182:	e8 c6 3f 00 00       	call   414d <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 14 66 00 00       	mov    0x6614,%eax
     190:	c7 44 24 04 b4 46 00 	movl   $0x46b4,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 ed 40 00 00       	call   428d <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 14 66 00 00       	mov    0x6614,%eax
     1b4:	c7 44 24 04 1e 47 00 	movl   $0x471e,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 c9 40 00 00       	call   428d <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 14 66 00 00       	mov    0x6614,%eax
     1d1:	c7 44 24 04 30 47 00 	movl   $0x4730,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 ac 40 00 00       	call   428d <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 3f 47 00 00 	movl   $0x473f,(%esp)
     1e8:	e8 78 3f 00 00       	call   4165 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 14 66 00 00       	mov    0x6614,%eax
     1f6:	c7 44 24 04 45 47 00 	movl   $0x4745,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 87 40 00 00       	call   428d <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 14 66 00 00       	mov    0x6614,%eax
     21e:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 5f 40 00 00       	call   428d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 3f 47 00 00 	movl   $0x473f,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 14 66 00 00       	mov    0x6614,%eax
     25b:	c7 44 24 04 5c 47 00 	movl   $0x475c,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 22 40 00 00       	call   428d <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 3f 47 00 00 	movl   $0x473f,(%esp)
     288:	e8 c0 3e 00 00       	call   414d <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 14 66 00 00       	mov    0x6614,%eax
     296:	c7 44 24 04 80 47 00 	movl   $0x4780,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 e7 3f 00 00       	call   428d <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 14 66 00 00       	mov    0x6614,%eax
     2b5:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 c8 3f 00 00       	call   428d <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 14 66 00 00       	mov    0x6614,%eax
     2d2:	c7 44 24 04 a1 47 00 	movl   $0x47a1,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 ab 3f 00 00       	call   428d <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 5c 46 00 00 	movl   $0x465c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 14 66 00 00       	mov    0x6614,%eax
     304:	c7 44 24 04 ac 47 00 	movl   $0x47ac,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 79 3f 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 bf 47 00 00 	movl   $0x47bf,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 14 66 00 00       	mov    0x6614,%eax
     346:	c7 44 24 04 cc 47 00 	movl   $0x47cc,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 37 3f 00 00       	call   428d <printf>
    exit();
     356:	e8 a2 3d 00 00       	call   40fd <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 14 66 00 00       	mov    0x6614,%eax
     360:	c7 44 24 04 ea 47 00 	movl   $0x47ea,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 1d 3f 00 00       	call   428d <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 14 66 00 00       	mov    0x6614,%eax
     37d:	c7 44 24 04 f8 47 00 	movl   $0x47f8,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 00 3f 00 00       	call   428d <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 09 48 00 00 	movl   $0x4809,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 14 66 00 00       	mov    0x6614,%eax
     3af:	c7 44 24 04 0f 48 00 	movl   $0x480f,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 ce 3e 00 00       	call   428d <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 14 66 00 00       	mov    0x6614,%eax
     3d0:	c7 44 24 04 2a 48 00 	movl   $0x482a,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 ad 3e 00 00       	call   428d <printf>
    exit();
     3e0:	e8 18 3d 00 00       	call   40fd <exit>
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     3e5:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     3ec:	00 
     3ed:	c7 44 24 04 46 48 00 	movl   $0x4846,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 14 66 00 00       	mov    0x6614,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 6c 3e 00 00       	call   428d <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 78 48 00 	movl   $0x4878,0x4(%esp)
     435:	00 
     ...
     446:	a1 14 66 00 00       	mov    0x6614,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 84 48 00 	movl   $0x4884,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 2b 3e 00 00       	call   428d <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 14 66 00 00       	mov    0x6614,%eax
     47a:	c7 44 24 04 a8 48 00 	movl   $0x48a8,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 03 3e 00 00       	call   428d <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 09 48 00 00 	movl   $0x4809,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 14 66 00 00       	mov    0x6614,%eax
     4b7:	c7 44 24 04 b3 48 00 	movl   $0x48b3,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 c6 3d 00 00       	call   428d <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 14 66 00 00       	mov    0x6614,%eax
     4f5:	c7 44 24 04 cc 48 00 	movl   $0x48cc,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 88 3d 00 00       	call   428d <printf>
    exit();
     505:	e8 f3 3b 00 00       	call   40fd <exit>
    printf(stdout, "read succeeded ok\n");
     50a:	a1 14 66 00 00       	mov    0x6614,%eax
     50f:	c7 44 24 04 e7 48 00 	movl   $0x48e7,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 6e 3d 00 00       	call   428d <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 09 48 00 00 	movl   $0x4809,(%esp)
    ...
    printf(stdout, "read failed\n");
     53c:	a1 14 66 00 00       	mov    0x6614,%eax
     541:	c7 44 24 04 fa 48 00 	movl   $0x48fa,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 3c 3d 00 00       	call   428d <printf>
    exit();
     551:	e8 a7 3b 00 00       	call   40fd <exit>
    printf(stdout, "unlink small failed\n");
     556:	a1 14 66 00 00       	mov    0x6614,%eax
     55b:	c7 44 24 04 07 49 00 	movl   $0x4907,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 22 3d 00 00       	call   428d <printf>
    exit();
     56b:	e8 8d 3b 00 00       	call   40fd <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 14 66 00 00       	mov    0x6614,%eax
     575:	c7 44 24 04 1c 49 00 	movl   $0x491c,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 08 3d 00 00       	call   428d <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 14 66 00 00       	mov    0x6614,%eax
     592:	c7 44 24 04 30 49 00 	movl   $0x4930,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 eb 3c 00 00       	call   428d <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 40 49 00 00 	movl   $0x4940,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 14 66 00 00       	mov    0x6614,%eax
     5c4:	c7 44 24 04 44 49 00 	movl   $0x4944,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 b9 3c 00 00       	call   428d <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 14 66 00 00       	mov    0x6614,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 5e 49 00 	movl   $0x495e,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 63 3c 00 00       	call   428d <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 40 49 00 00 	movl   $0x4940,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 14 66 00 00       	mov    0x6614,%eax
     66a:	c7 44 24 04 7c 49 00 	movl   $0x497c,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 13 3c 00 00       	call   428d <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b3:	a1 14 66 00 00       	mov    0x6614,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 95 49 00 	movl   $0x4995,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 be 3b 00 00       	call   428d <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 40 49 00 00 	movl   $0x4940,(%esp)
     ...
     6ff:	a1 14 66 00 00       	mov    0x6614,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 b2 49 00 	movl   $0x49b2,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 72 3b 00 00       	call   428d <printf>
      exit();
    ...
    printf(stdout, "unlink big failed\n");
     761:	a1 14 66 00 00       	mov    0x6614,%eax
     766:	c7 44 24 04 e4 49 00 	movl   $0x49e4,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 17 3b 00 00       	call   428d <printf>
    exit();
     776:	e8 82 39 00 00       	call   40fd <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 14 66 00 00       	mov    0x6614,%eax
     780:	c7 44 24 04 f7 49 00 	movl   $0x49f7,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 fd 3a 00 00       	call   428d <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 14 66 00 00       	mov    0x6614,%eax
     79d:	c7 44 24 04 08 4a 00 	movl   $0x4a08,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 e0 3a 00 00       	call   428d <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 14 66 00 00       	mov    0x6614,%eax
     838:	c7 44 24 04 30 4a 00 	movl   $0x4a30,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 45 3a 00 00       	call   428d <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 14 66 00 00       	mov    0x6614,%eax
     855:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 28 3a 00 00       	call   428d <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 62 4a 00 00 	movl   $0x4a62,(%esp)
     86c:	e8 f4 38 00 00       	call   4165 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 14 66 00 00       	mov    0x6614,%eax
     87a:	c7 44 24 04 85 46 00 	movl   $0x4685,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 03 3a 00 00       	call   428d <printf>
    exit();
     88a:	e8 6e 38 00 00       	call   40fd <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 62 4a 00 00 	movl   $0x4a62,(%esp)
     896:	e8 d2 38 00 00       	call   416d <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 14 66 00 00       	mov    0x6614,%eax
     8a4:	c7 44 24 04 67 4a 00 	movl   $0x4a67,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 d9 39 00 00       	call   428d <printf>
    exit();
     8b4:	e8 44 38 00 00       	call   40fd <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 7a 4a 00 00 	movl   $0x4a7a,(%esp)
     8c0:	e8 a8 38 00 00       	call   416d <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 14 66 00 00       	mov    0x6614,%eax
     8ce:	c7 44 24 04 7d 4a 00 	movl   $0x4a7d,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 af 39 00 00       	call   428d <printf>
    exit();
     8de:	e8 1a 38 00 00       	call   40fd <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 62 4a 00 00 	movl   $0x4a62,(%esp)
     8ea:	e8 5e 38 00 00       	call   414d <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 14 66 00 00       	mov    0x6614,%eax
     8f8:	c7 44 24 04 8e 4a 00 	movl   $0x4a8e,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 85 39 00 00       	call   428d <printf>
    exit();
     908:	e8 f0 37 00 00       	call   40fd <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 14 66 00 00       	mov    0x6614,%eax
     912:	c7 44 24 04 a2 4a 00 	movl   $0x4aa2,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 6b 39 00 00       	call   428d <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 14 66 00 00       	mov    0x6614,%eax
     92f:	c7 44 24 04 b1 4a 00 	movl   $0x4ab1,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 4e 39 00 00       	call   428d <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 00 66 00 	movl   $0x6600,0x4(%esp)
     946:	00 
     947:	c7 04 24 5c 46 00 00 	movl   $0x465c,(%esp)
     94e:	e8 e2 37 00 00       	call   4135 <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 14 66 00 00       	mov    0x6614,%eax
     95c:	c7 44 24 04 bc 4a 00 	movl   $0x4abc,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 21 39 00 00       	call   428d <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 ce 4a 00 	movl   $0x4ace,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 f1 38 00 00       	call   428d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 dd 4a 00 	movl   $0x4add,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 5f 38 00 00       	call   428d <printf>
        exit();
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 eb 4a 00 	movl   $0x4aeb,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 e9 37 00 00       	call   428d <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 f9 4a 00 	movl   $0x4af9,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 73 37 00 00       	call   428d <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 1f 4b 00 	movl   $0x4b1f,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 4a 37 00 00       	call   428d <printf>
     b43:	eb 19                	jmp    b5e <pipe1+0x1eb>
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 10 4b 00 	movl   $0x4b10,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 34 37 00 00       	call   428d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 29 4b 00 	movl   $0x4b29,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 13 37 00 00       	call   428d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 33 4b 00 	movl   $0x4b33,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 35 4b 00 	movl   $0x4b35,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 9b 36 00 00       	call   428d <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 49 4b 00 	movl   $0x4b49,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 4f 36 00 00       	call   428d <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 5c 4b 00 	movl   $0x4b5c,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 2e 36 00 00       	call   428d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 65 4b 00 	movl   $0x4b65,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 f9 35 00 00       	call   428d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 6e 4b 00 	movl   $0x4b6e,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 d6 35 00 00       	call   428d <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 a3 35 00 00       	call   428d <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 7a 4b 00 	movl   $0x4b7a,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 7d 35 00 00       	call   428d <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 8a 4b 00 	movl   $0x4b8a,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 58 35 00 00       	call   428d <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 97 4b 00 	movl   $0x4b97,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 3c 35 00 00       	call   428d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 eb 37 00 00       	call   4579 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 94 36 00 00       	call   4440 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 44 36 00 00       	call   4440 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 bb 4b 00 	movl   $0x4bbb,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 7d 34 00 00       	call   428d <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 c3 4b 00 	movl   $0x4bc3,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 57 34 00 00       	call   428d <printf>

  unlink("sharedfd");
     e36:	c7 04 24 d2 4b 00 00 	movl   $0x4bd2,(%esp)
     e3d:	e8 0b 33 00 00       	call   414d <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 d2 4b 00 00 	movl   $0x4bd2,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 dc 4b 00 	movl   $0x4bdc,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 1a 34 00 00       	call   428d <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 08 4c 00 	movl   $0x4c08,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 a8 33 00 00       	call   428d <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 d2 4b 00 00 	movl   $0x4bd2,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 28 4c 00 	movl   $0x4c28,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 4d 33 00 00       	call   428d <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 d2 4b 00 00 	movl   $0x4bd2,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 53 4c 00 	movl   $0x4c53,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 9e 32 00 00       	call   428d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 60 4c 00 	movl   $0x4c60,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 7a 32 00 00       	call   428d <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 75 4c 00 00 	movl   $0x4c75,-0x38(%ebp)
    1027:	c7 45 cc 78 4c 00 00 	movl   $0x4c78,-0x34(%ebp)
    102e:	c7 45 d0 7b 4c 00 00 	movl   $0x4c7b,-0x30(%ebp)
    1035:	c7 45 d4 7e 4c 00 00 	movl   $0x4c7e,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 81 4c 00 	movl   $0x4c81,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 3d 32 00 00       	call   428d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 fa 31 00 00       	call   428d <printf>
      exit();
    ...
    10be:	c7 44 24 04 91 4c 00 	movl   $0x4c91,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 bb 31 00 00       	call   428d <printf>
        exit();
    ...
    112c:	c7 44 24 04 a0 4c 00 	movl   $0x4ca0,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 4d 31 00 00       	call   428d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 b1 4c 00 	movl   $0x4cb1,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 a9 30 00 00       	call   428d <printf>
          exit();
    ...
    123a:	c7 44 24 04 bd 4c 00 	movl   $0x4cbd,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 3f 30 00 00       	call   428d <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 ce 4c 00 	movl   $0x4cce,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 0d 30 00 00       	call   428d <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 dc 4c 00 	movl   $0x4cdc,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 f1 2f 00 00       	call   428d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 c3 2f 00 00       	call   428d <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 91 4c 00 	movl   $0x4c91,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 62 2f 00 00       	call   428d <printf>
          exit();
    ...
    136c:	c7 44 24 04 80 47 00 	movl   $0x4780,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 0d 2f 00 00       	call   428d <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 f0 4c 00 	movl   $0x4cf0,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 50 2e 00 00       	call   428d <printf>
        exit();
    ...
    145b:	c7 44 24 04 14 4d 00 	movl   $0x4d14,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 1e 2e 00 00       	call   428d <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 34 4d 00 	movl   $0x4d34,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 95 2d 00 00       	call   428d <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 45 4d 00 	movl   $0x4d45,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 79 2d 00 00       	call   428d <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 56 4d 00 00 	movl   $0x4d56,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 61 4d 00 	movl   $0x4d61,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 48 2d 00 00       	call   428d <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 7b 4d 00 	movl   $0x4d7b,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 56 4d 00 00 	movl   $0x4d56,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 b7 4d 00 	movl   $0x4db7,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 4d 2c 00 00       	call   428d <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 ce 4d 00 	movl   $0x4dce,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 29 2c 00 00       	call   428d <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 e5 4d 00 	movl   $0x4de5,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 f0 2b 00 00       	call   428d <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 56 4d 00 00 	movl   $0x4d56,(%esp)
    16b4:	e8 94 2a 00 00       	call   414d <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 fe 4d 00 	movl   $0x4dfe,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 c0 2b 00 00       	call   428d <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 0d 4e 00 	movl   $0x4e0d,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 a4 2b 00 00       	call   428d <printf>

  unlink("lf1");
    16e9:	c7 04 24 17 4e 00 00 	movl   $0x4e17,(%esp)
    16f0:	e8 58 2a 00 00       	call   414d <unlink>
  unlink("lf2");
    16f5:	c7 04 24 1b 4e 00 00 	movl   $0x4e1b,(%esp)
    16fc:	e8 4c 2a 00 00       	call   414d <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 17 4e 00 00 	movl   $0x4e17,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 1f 4e 00 	movl   $0x4e1f,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 5b 2b 00 00       	call   428d <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 7b 4d 00 	movl   $0x4d7b,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 32 4e 00 	movl   $0x4e32,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 22 2b 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 1b 4e 00 00 	movl   $0x4e1b,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 81 4e 00 	movl   $0x4e81,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 73 2a 00 00       	call   428d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 92 4e 00 	movl   $0x4e92,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 3a 2a 00 00       	call   428d <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 1b 4e 00 	movl   $0x4e1b,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 1b 4e 00 00 	movl   $0x4e1b,(%esp)
    1872:	e8 e6 28 00 00       	call   415d <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 a3 4e 00 	movl   $0x4ea3,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 fe 29 00 00       	call   428d <printf>
    exit();
    188f:	e8 69 28 00 00       	call   40fd <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 1b 4e 00 00 	movl   $0x4e1b,(%esp)
    189b:	e8 ad 28 00 00       	call   414d <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 17 4e 00 	movl   $0x4e17,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 1b 4e 00 00 	movl   $0x4e1b,(%esp)
    18af:	e8 a9 28 00 00       	call   415d <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 c4 4e 00 	movl   $0x4ec4,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 c1 29 00 00       	call   428d <printf>
    exit();
    18cc:	e8 2c 28 00 00       	call   40fd <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 17 4e 00 	movl   $0x4e17,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 e7 4e 00 00 	movl   $0x4ee7,(%esp)
    18e0:	e8 78 28 00 00       	call   415d <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 e9 4e 00 	movl   $0x4ee9,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 90 29 00 00       	call   428d <printf>
    exit();
    18fd:	e8 fb 27 00 00       	call   40fd <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 05 4f 00 	movl   $0x4f05,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 77 29 00 00       	call   428d <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 12 4f 00 	movl   $0x4f12,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 5b 29 00 00       	call   428d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 22 4f 00 00 	movl   $0x4f22,(%esp)
    ...
    19d4:	c7 04 24 22 4f 00 00 	movl   $0x4f22,(%esp)
    ...
    1a05:	c7 44 24 04 25 4f 00 	movl   $0x4f25,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 74 28 00 00       	call   428d <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 e7 4e 00 00 	movl   $0x4ee7,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 41 4f 00 	movl   $0x4f41,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 ad 27 00 00       	call   428d <printf>
        exit();
    ...
    1afe:	c7 44 24 04 5a 4f 00 	movl   $0x4f5a,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 7b 27 00 00       	call   428d <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 78 4f 00 	movl   $0x4f78,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 20 27 00 00       	call   428d <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 e4 26 00 00       	call   428d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 a9 4f 00 	movl   $0x4fa9,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 c4 25 00 00       	call   428d <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 b7 4f 00 	movl   $0x4fb7,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 a8 25 00 00       	call   428d <printf>

  unlink("x");
    1ce5:	c7 04 24 33 4b 00 00 	movl   $0x4b33,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 7a 25 00 00       	call   428d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 33 4b 00 00 	movl   $0x4b33,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 33 4b 00 	movl   $0x4b33,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 c8 4f 00 00 	movl   $0x4fc8,(%esp)
    1db0:	e8 a8 23 00 00       	call   415d <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 33 4b 00 00 	movl   $0x4b33,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 cc 4f 00 	movl   $0x4fcc,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 96 24 00 00       	call   428d <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 db 4f 00 	movl   $0x4fdb,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 7a 24 00 00       	call   428d <printf>
  unlink("bd");
    1e13:	c7 04 24 e8 4f 00 00 	movl   $0x4fe8,(%esp)
    1e1a:	e8 2e 23 00 00       	call   414d <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 e8 4f 00 00 	movl   $0x4fe8,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 eb 4f 00 	movl   $0x4feb,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 3d 24 00 00       	call   428d <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 e8 4f 00 00 	movl   $0x4fe8,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 15 50 00 	movl   $0x5015,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 4f 23 00 00       	call   428d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 2a 50 00 	movl   $0x502a,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 29 23 00 00       	call   428d <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 35 50 00 	movl   $0x5035,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 0d 23 00 00       	call   428d <printf>

  unlink("ff");
    1f80:	c7 04 24 42 50 00 00 	movl   $0x5042,(%esp)
    1f87:	e8 c1 21 00 00       	call   414d <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 45 50 00 00 	movl   $0x5045,(%esp)
    1f93:	e8 cd 21 00 00       	call   4165 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 48 50 00 	movl   $0x5048,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 dd 22 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 60 50 00 00 	movl   $0x5060,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 66 50 00 	movl   $0x5066,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 a7 22 00 00       	call   428d <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 42 50 00 	movl   $0x5042,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 c4 50 00 00 	movl   $0x50c4,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 cd 50 00 	movl   $0x50cd,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 f9 21 00 00       	call   428d <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 e5 50 00 	movl   $0x50e5,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 e8 50 00 00 	movl   $0x50e8,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 f4 50 00 	movl   $0x50f4,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 9d 21 00 00       	call   428d <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 0d 51 00 	movl   $0x510d,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 55 21 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 28 51 00 00 	movl   $0x5128,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 f2 51 00 	movl   $0x51f2,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 e5 1f 00 00       	call   428d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 0a 52 00 	movl   $0x520a,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 ac 1f 00 00       	call   428d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 84 54 00 	movl   $0x5484,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 c7 1b 00 00       	call   428d <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 93 54 00 00 	movl   $0x5493,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 93 54 00 00 	movl   $0x5493,(%esp)
    ...
    26fb:	c7 44 24 04 9c 54 00 	movl   $0x549c,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 7e 1b 00 00       	call   428d <printf>
      exit();
    ...
    2750:	c7 44 24 04 b4 54 00 	movl   $0x54b4,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 29 1b 00 00       	call   428d <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 93 54 00 00 	movl   $0x5493,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 c6 54 00 	movl   $0x54c6,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 db 1a 00 00       	call   428d <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 d3 54 00 	movl   $0x54d3,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 bf 1a 00 00       	call   428d <printf>

  unlink("bigfile");
    27ce:	c7 04 24 e1 54 00 00 	movl   $0x54e1,(%esp)
    27d5:	e8 73 19 00 00       	call   414d <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 e1 54 00 00 	movl   $0x54e1,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 e9 54 00 	movl   $0x54e9,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 82 1a 00 00       	call   428d <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 ff 54 00 	movl   $0x54ff,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 23 1a 00 00       	call   428d <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 e1 54 00 00 	movl   $0x54e1,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 15 55 00 	movl   $0x5515,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 d8 19 00 00       	call   428d <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 2a 55 00 	movl   $0x552a,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 8d 19 00 00       	call   428d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 3f 55 00 	movl   $0x553f,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 4a 19 00 00       	call   428d <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 53 55 00 	movl   $0x5553,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 fd 18 00 00       	call   428d <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    29a4:	c7 44 24 04 6c 55 00 	movl   $0x556c,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 d5 18 00 00       	call   428d <printf>
    exit();
    29b8:	e8 40 17 00 00       	call   40fd <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 e1 54 00 00 	movl   $0x54e1,(%esp)
    29c4:	e8 84 17 00 00       	call   414d <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 86 55 00 	movl   $0x5586,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 b0 18 00 00       	call   428d <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 24 56 00 00 	movl   $0x5624,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 54 56 00 	movl   $0x5654,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 11 18 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 94 56 00 00 	movl   $0x5694,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 c4 56 00 	movl   $0x56c4,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 d0 17 00 00       	call   428d <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 5b 58 00 	movl   $0x585b,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 c6 15 00 00       	call   428d <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 68 58 00 00 	movl   $0x5868,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 70 58 00 	movl   $0x5870,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 95 15 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 a1 58 00 00 	movl   $0x58a1,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 ac 58 00 	movl   $0x58ac,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 2b 15 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 a1 58 00 00 	movl   $0x58a1,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 e7 4e 00 00 	movl   $0x4ee7,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 44 59 00 	movl   $0x5944,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 13 14 00 00       	call   428d <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 63 59 00 	movl   $0x5963,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 c4 13 00 00       	call   428d <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 77 59 00 	movl   $0x5977,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 a0 13 00 00       	call   428d <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 87 59 00 	movl   $0x5987,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 84 13 00 00       	call   428d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 c7 59 00 00 	movl   $0x59c7,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 c7 59 00 00 	movl   $0x59c7,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 ce 46 00 00 	movl   $0x46ce,(%esp)
    2ff8:	e8 70 11 00 00       	call   416d <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 ca 59 00 	movl   $0x59ca,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 7c 12 00 00       	call   428d <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 de 59 00 	movl   $0x59de,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 60 12 00 00       	call   428d <printf>
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 ec 59 00 	movl   $0x59ec,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 12 12 00 00       	call   428d <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 0e 5a 00 	movl   $0x5a0e,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 ee 11 00 00       	call   428d <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 22 5a 00 	movl   $0x5a22,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 c1 11 00 00       	call   428d <printf>
    exit();
    30cc:	e8 2c 10 00 00       	call   40fd <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 35 5a 00 	movl   $0x5a35,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 a8 11 00 00       	call   428d <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 14 66 00 00       	mov    0x6614,%eax
    30f6:	c7 44 24 04 43 5a 00 	movl   $0x5a43,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 87 11 00 00       	call   428d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    3144:	a1 14 66 00 00       	mov    0x6614,%eax
    ...
    315e:	c7 44 24 04 4e 5a 00 	movl   $0x5a4e,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 1f 11 00 00       	call   428d <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 14 66 00 00       	mov    0x6614,%eax
    31a2:	c7 44 24 04 69 5a 00 	movl   $0x5a69,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 db 10 00 00       	call   428d <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 14 66 00 00       	mov    0x6614,%eax
    31e5:	c7 44 24 04 80 5a 00 	movl   $0x5a80,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 98 10 00 00       	call   428d <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    323e:	a1 14 66 00 00       	mov    0x6614,%eax
    3243:	c7 44 24 04 9c 5a 00 	movl   $0x5a9c,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 3a 10 00 00       	call   428d <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 14 66 00 00       	mov    0x6614,%eax
    328e:	c7 44 24 04 da 5a 00 	movl   $0x5ada,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 ef 0f 00 00       	call   428d <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 14 66 00 00       	mov    0x6614,%eax
    ...
    32d2:	c7 44 24 04 f8 5a 00 	movl   $0x5af8,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 ab 0f 00 00       	call   428d <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 14 66 00 00       	mov    0x6614,%eax
    ...
    3339:	c7 44 24 04 30 5b 00 	movl   $0x5b30,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 44 0f 00 00       	call   428d <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 14 66 00 00       	mov    0x6614,%eax
    335d:	c7 44 24 04 58 5b 00 	movl   $0x5b58,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 20 0f 00 00       	call   428d <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 14 66 00 00       	mov    0x6614,%eax
    ...
    33ba:	c7 44 24 04 88 5b 00 	movl   $0x5b88,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 c3 0e 00 00       	call   428d <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 14 66 00 00       	mov    0x6614,%eax
    33f3:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 8a 0e 00 00       	call   428d <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 ce 4a 00 	movl   $0x4ace,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 0a 0e 00 00       	call   428d <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 33 4b 00 	movl   $0x4b33,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 14 66 00 00       	mov    0x6614,%eax
    3578:	c7 44 24 04 c2 5b 00 	movl   $0x5bc2,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 05 0d 00 00       	call   428d <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 14 66 00 00       	mov    0x6614,%eax
    35be:	c7 44 24 04 dd 5b 00 	movl   $0x5bdd,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 bf 0c 00 00       	call   428d <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 14 66 00 00       	mov    0x6614,%eax
    3604:	c7 44 24 04 eb 5b 00 	movl   $0x5beb,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 79 0c 00 00       	call   428d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 fa 5b 00 00 	movl   $0x5bfa,(%esp)
    3678:	e8 e0 0a 00 00       	call   415d <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 14 66 00 00       	mov    0x6614,%eax
    3687:	c7 44 24 04 05 5c 00 	movl   $0x5c05,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 f6 0b 00 00       	call   428d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 14 66 00 00       	mov    0x6614,%eax
    36b4:	c7 44 24 04 1e 5c 00 	movl   $0x5c1e,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 c9 0b 00 00       	call   428d <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 14 66 00 00       	mov    0x6614,%eax
    36d1:	c7 44 24 04 2b 5c 00 	movl   $0x5c2b,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 ac 0b 00 00       	call   428d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 14 66 00 00       	mov    0x6614,%eax
    36fe:	c7 44 24 04 35 5c 00 	movl   $0x5c35,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 7f 0b 00 00       	call   428d <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 14 66 00 00       	mov    0x6614,%eax
    3726:	c7 44 24 04 46 5c 00 	movl   $0x5c46,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 57 0b 00 00       	call   428d <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 53 5c 00 00 	movl   $0x5c53,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 40 66 00 00 	movl   $0x5c60,0x6640(,%eax,4)
    376f:	60 5c 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3787:	a1 14 66 00 00       	mov    0x6614,%eax
    378c:	c7 44 24 04 3d 5d 00 	movl   $0x5d3d,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 f1 0a 00 00       	call   428d <printf>
    exec("echo", args);
    379c:	c7 44 24 04 40 66 00 	movl   $0x6640,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 5c 46 00 00 	movl   $0x465c,(%esp)
    37ab:	e8 85 09 00 00       	call   4135 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 14 66 00 00       	mov    0x6614,%eax
    37b5:	c7 44 24 04 4a 5d 00 	movl   $0x5d4a,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 c8 0a 00 00       	call   428d <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 53 5c 00 00 	movl   $0x5c53,(%esp)
    ...
    37f2:	a1 14 66 00 00       	mov    0x6614,%eax
    37f7:	c7 44 24 04 5a 5d 00 	movl   $0x5d5a,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 86 0a 00 00       	call   428d <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 53 5c 00 00 	movl   $0x5c53,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 14 66 00 00       	mov    0x6614,%eax
    3833:	c7 44 24 04 73 5d 00 	movl   $0x5d73,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 4a 0a 00 00       	call   428d <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 53 5c 00 00 	movl   $0x5c53,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 88 5d 00 	movl   $0x5d88,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 0a 0a 00 00       	call   428d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 95 5d 00 	movl   $0x5d95,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 20 09 00 00       	call   428d <printf>
    ...
    3990:	c7 44 24 04 a1 5d 00 	movl   $0x5da1,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 e9 08 00 00       	call   428d <printf>
      break;
    ...
    39dc:	c7 44 24 04 b1 5d 00 	movl   $0x5db1,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 9d 08 00 00       	call   428d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 c1 5d 00 	movl   $0x5dc1,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 79 07 00 00       	call   428d <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 d7 5d 00 	movl   $0x5dd7,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 4f 07 00 00       	call   428d <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 e4 5d 00 	movl   $0x5de4,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 0a 07 00 00       	call   428d <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 fd 46 00 	movl   $0x46fd,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 eb 06 00 00       	call   428d <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 05 5e 00 	movl   $0x5e05,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 cd 06 00 00       	call   428d <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 14 5e 00 00 	movl   $0x5e14,(%esp)
  ...
  if (fd < 0) {
    ...
    3be5:	c7 44 24 04 19 5e 00 	movl   $0x5e19,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 94 06 00 00       	call   428d <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 26 5e 00 	movl   $0x5e26,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 4a 06 00 00       	call   428d <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c48:	a1 18 66 00 00       	mov    0x6618,%eax
    3c4d:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c53:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c58:	a3 18 66 00 00       	mov    %eax,0x6618
  return randstate;
    3c5d:	a1 18 66 00 00       	mov    0x6618,%eax
}
    3c62:	5d                   	pop    %ebp
    3c63:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cb9:	00 
    3cba:	c7 04 24 4b 5e 00 00 	movl   $0x5e4b,(%esp)
...
ps() {
  ...
  printf(1, "PID	TKTS	TCKS	STAT	NAME\n");
    3ff5:	c7 44 24 04 86 5e 00 	movl   $0x5e86,0x4(%esp)
    3ffc:	00 
    3ffd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4004:	e8 84 02 00 00       	call   428d <printf>
  getpinfo(&pstat);
  ...
  while (pstat[i].pid != 0) {
    ...
    40b1:	c7 44 24 04 9f 5e 00 	movl   $0x5e9f,0x4(%esp)
    40b8:	00 
    40b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    40c0:	e8 c8 01 00 00       	call   428d <printf>
      i++;
...
000041a5 <settickets>:
SYSCALL(settickets)
    41a5:	b8 17 00 00 00       	mov    $0x17,%eax
    41aa:	cd 40                	int    $0x40
    41ac:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    41b0:	83 ec 18             	sub    $0x18,%esp
    41b3:	8b 45 0c             	mov    0xc(%ebp),%eax
    41b6:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    41b9:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    41c0:	00 
    41c1:	8d 45 f4             	lea    -0xc(%ebp),%eax
    41c4:	89 44 24 04          	mov    %eax,0x4(%esp)
    41c8:	8b 45 08             	mov    0x8(%ebp),%eax
    41cb:	89 04 24             	mov    %eax,(%esp)
    41ce:	e8 4a ff ff ff       	call   411d <write>
}
    41d3:	c9                   	leave  
    41d4:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    41dd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    41e4:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    41e8:	74 17                	je     4201 <printint+0x2c>
    41ea:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    41ee:	79 11                	jns    4201 <printint+0x2c>
    neg = 1;
    41f0:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    41f7:	8b 45 0c             	mov    0xc(%ebp),%eax
    41fa:	f7 d8                	neg    %eax
    41fc:	89 45 ec             	mov    %eax,-0x14(%ebp)
    41ff:	eb 06                	jmp    4207 <printint+0x32>
  } else {
    x = xx;
    4201:	8b 45 0c             	mov    0xc(%ebp),%eax
    4204:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    4207:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    420e:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4211:	8d 41 01             	lea    0x1(%ecx),%eax
    4214:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4217:	8b 5d 10             	mov    0x10(%ebp),%ebx
    421a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    421d:	ba 00 00 00 00       	mov    $0x0,%edx
    4222:	f7 f3                	div    %ebx
    4224:	89 d0                	mov    %edx,%eax
    4226:	0f b6 80 1c 66 00 00 	movzbl 0x661c(%eax),%eax
    422d:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4231:	8b 75 10             	mov    0x10(%ebp),%esi
    4234:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4237:	ba 00 00 00 00       	mov    $0x0,%edx
    423c:	f7 f6                	div    %esi
    423e:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4241:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4245:	75 c7                	jne    420e <printint+0x39>
  if(neg)
    4247:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    424b:	74 10                	je     425d <printint+0x88>
    buf[i++] = '-';
    424d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4250:	8d 50 01             	lea    0x1(%eax),%edx
    4253:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4256:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    425b:	eb 1f                	jmp    427c <printint+0xa7>
    425d:	eb 1d                	jmp    427c <printint+0xa7>
    putc(fd, buf[i]);
    425f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4262:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4265:	01 d0                	add    %edx,%eax
    4267:	0f b6 00             	movzbl (%eax),%eax
    426a:	0f be c0             	movsbl %al,%eax
    426d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4271:	8b 45 08             	mov    0x8(%ebp),%eax
    4274:	89 04 24             	mov    %eax,(%esp)
    4277:	e8 31 ff ff ff       	call   41ad <putc>
  while(--i >= 0)
    427c:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4280:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4284:	79 d9                	jns    425f <printint+0x8a>
}
    4286:	83 c4 30             	add    $0x30,%esp
    4289:	5b                   	pop    %ebx
    428a:	5e                   	pop    %esi
    428b:	5d                   	pop    %ebp
    428c:	c3                   	ret    
...
{
    428d:	55                   	push   %ebp
    428e:	89 e5                	mov    %esp,%ebp
    4290:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4293:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    429a:	8d 45 0c             	lea    0xc(%ebp),%eax
    429d:	83 c0 04             	add    $0x4,%eax
    42a0:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    42a3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    42aa:	e9 7c 01 00 00       	jmp    442b <printf+0x19e>
    c = fmt[i] & 0xff;
    42af:	8b 55 0c             	mov    0xc(%ebp),%edx
    42b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    42b5:	01 d0                	add    %edx,%eax
    42b7:	0f b6 00             	movzbl (%eax),%eax
    42ba:	0f be c0             	movsbl %al,%eax
    42bd:	25 ff 00 00 00       	and    $0xff,%eax
    42c2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    42c5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    42c9:	75 2c                	jne    42f7 <printf+0x6a>
      if(c == '%'){
    42cb:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42cf:	75 0c                	jne    42dd <printf+0x50>
        state = '%';
    42d1:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    42d8:	e9 4a 01 00 00       	jmp    4427 <printf+0x19a>
      } else {
        putc(fd, c);
    42dd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42e0:	0f be c0             	movsbl %al,%eax
    42e3:	89 44 24 04          	mov    %eax,0x4(%esp)
    42e7:	8b 45 08             	mov    0x8(%ebp),%eax
    42ea:	89 04 24             	mov    %eax,(%esp)
    42ed:	e8 bb fe ff ff       	call   41ad <putc>
    42f2:	e9 30 01 00 00       	jmp    4427 <printf+0x19a>
      }
    } else if(state == '%'){
    42f7:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    42fb:	0f 85 26 01 00 00    	jne    4427 <printf+0x19a>
      if(c == 'd'){
    4301:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    4305:	75 2d                	jne    4334 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    4307:	8b 45 e8             	mov    -0x18(%ebp),%eax
    430a:	8b 00                	mov    (%eax),%eax
    430c:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4313:	00 
    4314:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    431b:	00 
    431c:	89 44 24 04          	mov    %eax,0x4(%esp)
    4320:	8b 45 08             	mov    0x8(%ebp),%eax
    4323:	89 04 24             	mov    %eax,(%esp)
    4326:	e8 aa fe ff ff       	call   41d5 <printint>
        ap++;
    432b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    432f:	e9 ec 00 00 00       	jmp    4420 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4334:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4338:	74 06                	je     4340 <printf+0xb3>
    433a:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    433e:	75 2d                	jne    436d <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4340:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4343:	8b 00                	mov    (%eax),%eax
    4345:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    434c:	00 
    434d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4354:	00 
    4355:	89 44 24 04          	mov    %eax,0x4(%esp)
    4359:	8b 45 08             	mov    0x8(%ebp),%eax
    435c:	89 04 24             	mov    %eax,(%esp)
    435f:	e8 71 fe ff ff       	call   41d5 <printint>
        ap++;
    4364:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4368:	e9 b3 00 00 00       	jmp    4420 <printf+0x193>
      } else if(c == 's'){
    436d:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4371:	75 45                	jne    43b8 <printf+0x12b>
        s = (char*)*ap;
    4373:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4376:	8b 00                	mov    (%eax),%eax
    4378:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    437b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    437f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4383:	75 09                	jne    438e <printf+0x101>
          s = "(null)";
    4385:	c7 45 f4 af 5e 00 00 	movl   $0x5eaf,-0xc(%ebp)
        while(*s != 0){
    438c:	eb 1e                	jmp    43ac <printf+0x11f>
    438e:	eb 1c                	jmp    43ac <printf+0x11f>
          putc(fd, *s);
    4390:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4393:	0f b6 00             	movzbl (%eax),%eax
    4396:	0f be c0             	movsbl %al,%eax
    4399:	89 44 24 04          	mov    %eax,0x4(%esp)
    439d:	8b 45 08             	mov    0x8(%ebp),%eax
    43a0:	89 04 24             	mov    %eax,(%esp)
    43a3:	e8 05 fe ff ff       	call   41ad <putc>
          s++;
    43a8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    43ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43af:	0f b6 00             	movzbl (%eax),%eax
    43b2:	84 c0                	test   %al,%al
    43b4:	75 da                	jne    4390 <printf+0x103>
    43b6:	eb 68                	jmp    4420 <printf+0x193>
        }
      } else if(c == 'c'){
    43b8:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    43bc:	75 1d                	jne    43db <printf+0x14e>
        putc(fd, *ap);
    43be:	8b 45 e8             	mov    -0x18(%ebp),%eax
    43c1:	8b 00                	mov    (%eax),%eax
    43c3:	0f be c0             	movsbl %al,%eax
    43c6:	89 44 24 04          	mov    %eax,0x4(%esp)
    43ca:	8b 45 08             	mov    0x8(%ebp),%eax
    43cd:	89 04 24             	mov    %eax,(%esp)
    43d0:	e8 d8 fd ff ff       	call   41ad <putc>
        ap++;
    43d5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    43d9:	eb 45                	jmp    4420 <printf+0x193>
      } else if(c == '%'){
    43db:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    43df:	75 17                	jne    43f8 <printf+0x16b>
        putc(fd, c);
    43e1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    43e4:	0f be c0             	movsbl %al,%eax
    43e7:	89 44 24 04          	mov    %eax,0x4(%esp)
    43eb:	8b 45 08             	mov    0x8(%ebp),%eax
    43ee:	89 04 24             	mov    %eax,(%esp)
    43f1:	e8 b7 fd ff ff       	call   41ad <putc>
    43f6:	eb 28                	jmp    4420 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    43f8:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    43ff:	00 
    4400:	8b 45 08             	mov    0x8(%ebp),%eax
    4403:	89 04 24             	mov    %eax,(%esp)
    4406:	e8 a2 fd ff ff       	call   41ad <putc>
        putc(fd, c);
    440b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    440e:	0f be c0             	movsbl %al,%eax
    4411:	89 44 24 04          	mov    %eax,0x4(%esp)
    4415:	8b 45 08             	mov    0x8(%ebp),%eax
    4418:	89 04 24             	mov    %eax,(%esp)
    441b:	e8 8d fd ff ff       	call   41ad <putc>
      }
      state = 0;
    4420:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    4427:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    442b:	8b 55 0c             	mov    0xc(%ebp),%edx
    442e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4431:	01 d0                	add    %edx,%eax
    4433:	0f b6 00             	movzbl (%eax),%eax
    4436:	84 c0                	test   %al,%al
    4438:	0f 85 71 fe ff ff    	jne    42af <printf+0x22>
    }
  }
}
    443e:	c9                   	leave  
...
free(void *ap)
{
    ...
    4443:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4446:	8b 45 08             	mov    0x8(%ebp),%eax
    4449:	83 e8 08             	sub    $0x8,%eax
    444c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    444f:	a1 c8 66 00 00       	mov    0x66c8,%eax
    4454:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4457:	eb 24                	jmp    447d <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4459:	8b 45 fc             	mov    -0x4(%ebp),%eax
    445c:	8b 00                	mov    (%eax),%eax
    445e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4461:	77 12                	ja     4475 <free+0x35>
    4463:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4466:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4469:	77 24                	ja     448f <free+0x4f>
    446b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    446e:	8b 00                	mov    (%eax),%eax
    4470:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4473:	77 1a                	ja     448f <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4475:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4478:	8b 00                	mov    (%eax),%eax
    447a:	89 45 fc             	mov    %eax,-0x4(%ebp)
    447d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4480:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4483:	76 d4                	jbe    4459 <free+0x19>
    4485:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4488:	8b 00                	mov    (%eax),%eax
    448a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    448d:	76 ca                	jbe    4459 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    448f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4492:	8b 40 04             	mov    0x4(%eax),%eax
    4495:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    449c:	8b 45 f8             	mov    -0x8(%ebp),%eax
    449f:	01 c2                	add    %eax,%edx
    44a1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44a4:	8b 00                	mov    (%eax),%eax
    44a6:	39 c2                	cmp    %eax,%edx
    44a8:	75 24                	jne    44ce <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    44aa:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44ad:	8b 50 04             	mov    0x4(%eax),%edx
    44b0:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44b3:	8b 00                	mov    (%eax),%eax
    44b5:	8b 40 04             	mov    0x4(%eax),%eax
    44b8:	01 c2                	add    %eax,%edx
    44ba:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44bd:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    44c0:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44c3:	8b 00                	mov    (%eax),%eax
    44c5:	8b 10                	mov    (%eax),%edx
    44c7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44ca:	89 10                	mov    %edx,(%eax)
    44cc:	eb 0a                	jmp    44d8 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    44ce:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44d1:	8b 10                	mov    (%eax),%edx
    44d3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44d6:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    44d8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44db:	8b 40 04             	mov    0x4(%eax),%eax
    44de:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    44e5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44e8:	01 d0                	add    %edx,%eax
    44ea:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    44ed:	75 20                	jne    450f <free+0xcf>
    p->s.size += bp->s.size;
    44ef:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44f2:	8b 50 04             	mov    0x4(%eax),%edx
    44f5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    44f8:	8b 40 04             	mov    0x4(%eax),%eax
    44fb:	01 c2                	add    %eax,%edx
    44fd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4500:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4503:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4506:	8b 10                	mov    (%eax),%edx
    4508:	8b 45 fc             	mov    -0x4(%ebp),%eax
    450b:	89 10                	mov    %edx,(%eax)
    450d:	eb 08                	jmp    4517 <free+0xd7>
  } else
    p->s.ptr = bp;
    450f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4512:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4515:	89 10                	mov    %edx,(%eax)
  freep = p;
    4517:	8b 45 fc             	mov    -0x4(%ebp),%eax
    451a:	a3 c8 66 00 00       	mov    %eax,0x66c8
}
    451f:	c9                   	leave  
    4520:	c3                   	ret    
...
{
    4521:	55                   	push   %ebp
    4522:	89 e5                	mov    %esp,%ebp
    4524:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4527:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    452e:	77 07                	ja     4537 <morecore+0x16>
    nu = 4096;
    4530:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4537:	8b 45 08             	mov    0x8(%ebp),%eax
    453a:	c1 e0 03             	shl    $0x3,%eax
    453d:	89 04 24             	mov    %eax,(%esp)
    4540:	e8 40 fc ff ff       	call   4185 <sbrk>
    4545:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4548:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    454c:	75 07                	jne    4555 <morecore+0x34>
    return 0;
    454e:	b8 00 00 00 00       	mov    $0x0,%eax
    4553:	eb 22                	jmp    4577 <morecore+0x56>
  hp = (Header*)p;
    4555:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4558:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    455b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    455e:	8b 55 08             	mov    0x8(%ebp),%edx
    4561:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4564:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4567:	83 c0 08             	add    $0x8,%eax
    456a:	89 04 24             	mov    %eax,(%esp)
    456d:	e8 ce fe ff ff       	call   4440 <free>
  return freep;
    4572:	a1 c8 66 00 00       	mov    0x66c8,%eax
}
    4577:	c9                   	leave  
    4578:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    457c:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    457f:	8b 45 08             	mov    0x8(%ebp),%eax
    4582:	83 c0 07             	add    $0x7,%eax
    4585:	c1 e8 03             	shr    $0x3,%eax
    4588:	83 c0 01             	add    $0x1,%eax
    458b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    458e:	a1 c8 66 00 00       	mov    0x66c8,%eax
    4593:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4596:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    459a:	75 23                	jne    45bf <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    459c:	c7 45 f0 c0 66 00 00 	movl   $0x66c0,-0x10(%ebp)
    45a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45a6:	a3 c8 66 00 00       	mov    %eax,0x66c8
    45ab:	a1 c8 66 00 00       	mov    0x66c8,%eax
    45b0:	a3 c0 66 00 00       	mov    %eax,0x66c0
    base.s.size = 0;
    45b5:	c7 05 c4 66 00 00 00 	movl   $0x0,0x66c4
    45bc:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    45bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45c2:	8b 00                	mov    (%eax),%eax
    45c4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    45c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45ca:	8b 40 04             	mov    0x4(%eax),%eax
    45cd:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    45d0:	72 4d                	jb     461f <malloc+0xa6>
      if(p->s.size == nunits)
    45d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45d5:	8b 40 04             	mov    0x4(%eax),%eax
    45d8:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    45db:	75 0c                	jne    45e9 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    45dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45e0:	8b 10                	mov    (%eax),%edx
    45e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45e5:	89 10                	mov    %edx,(%eax)
    45e7:	eb 26                	jmp    460f <malloc+0x96>
      else {
        p->s.size -= nunits;
    45e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45ec:	8b 40 04             	mov    0x4(%eax),%eax
    45ef:	2b 45 ec             	sub    -0x14(%ebp),%eax
    45f2:	89 c2                	mov    %eax,%edx
    45f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45f7:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    45fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45fd:	8b 40 04             	mov    0x4(%eax),%eax
    4600:	c1 e0 03             	shl    $0x3,%eax
    4603:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4606:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4609:	8b 55 ec             	mov    -0x14(%ebp),%edx
    460c:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    460f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4612:	a3 c8 66 00 00       	mov    %eax,0x66c8
      return (void*)(p + 1);
    4617:	8b 45 f4             	mov    -0xc(%ebp),%eax
    461a:	83 c0 08             	add    $0x8,%eax
    461d:	eb 38                	jmp    4657 <malloc+0xde>
    }
    if(p == freep)
    461f:	a1 c8 66 00 00       	mov    0x66c8,%eax
    4624:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4627:	75 1b                	jne    4644 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4629:	8b 45 ec             	mov    -0x14(%ebp),%eax
    462c:	89 04 24             	mov    %eax,(%esp)
    462f:	e8 ed fe ff ff       	call   4521 <morecore>
    4634:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4637:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    463b:	75 07                	jne    4644 <malloc+0xcb>
        return 0;
    463d:	b8 00 00 00 00       	mov    $0x0,%eax
    4642:	eb 13                	jmp    4657 <malloc+0xde>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4644:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4647:	89 45 f0             	mov    %eax,-0x10(%ebp)
    464a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    464d:	8b 00                	mov    (%eax),%eax
    464f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }
    4652:	e9 70 ff ff ff       	jmp    45c7 <malloc+0x4e>
}
    4657:	c9                   	leave  
    4658:	c3                   	ret    
