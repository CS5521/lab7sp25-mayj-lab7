...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 f4 15 00 00 	mov    0x15f4(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 c8 15 00 00 	movl   $0x15c8,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 cf 15 00 	movl   $0x15cf,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 81 11 00 00       	call   11fc <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 df 15 00 	movl   $0x15df,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 2e 11 00 00       	call   11fc <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 ef 15 00 00 	movl   $0x15ef,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 0c 16 00 	movl   $0x160c,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 d7 0f 00 00       	call   11fc <printf>
  memset(buf, 0, nbuf);
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     290:	00 
     291:	c7 04 24 0f 16 00 00 	movl   $0x160f,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     2fb:	00 
     2fc:	c7 44 24 04 17 16 00 	movl   $0x1617,0x4(%esp)
     303:	00 
     304:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     30b:	e8 ec 0e 00 00       	call   11fc <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     364:	c7 44 24 04 25 16 00 	movl   $0x1625,0x4(%esp)
     36b:	00 
     36c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     373:	e8 84 0e 00 00       	call   11fc <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     391:	c7 04 24 29 16 00 00 	movl   $0x1629,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3af:	e8 34 11 00 00       	call   14e8 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ed:	e8 f6 10 00 00       	call   14e8 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     458:	e8 8b 10 00 00       	call   14e8 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4a8:	e8 3b 10 00 00       	call   14e8 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4f8:	e8 eb 0f 00 00       	call   14e8 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 98 1b 00 00 	movl   $0x1b98,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 98 1b 00 00 	movl   $0x1b98,(%esp)
     ...
     622:	c7 04 24 9e 1b 00 00 	movl   $0x1b9e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 98 1b 00 00 	movl   $0x1b98,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 98 1b 00 00 	movl   $0x1b98,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 2e 16 00 	movl   $0x162e,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 2f 16 00 	movl   $0x162f,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 9e 0a 00 00       	call   11fc <printf>
    panic("syntax");
     75e:	c7 04 24 3e 16 00 00 	movl   $0x163e,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 45 16 00 	movl   $0x1645,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 47 16 00 	movl   $0x1647,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 49 16 00 	movl   $0x1649,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 4b 16 00 00 	movl   $0x164b,(%esp)
    ...
    case '+':  // >>
     ...
     9d6:	90                   	nop
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 68 16 00 	movl   $0x1668,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 6b 16 00 	movl   $0x166b,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 6d 16 00 00 	movl   $0x166d,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 78 16 00 	movl   $0x1678,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 7a 16 00 00 	movl   $0x167a,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 6b 16 00 	movl   $0x166b,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 3e 16 00 00 	movl   $0x163e,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 8d 16 00 00 	movl   $0x168d,(%esp)
  ...
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 9b 16 00 	movl   $0x169b,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 a0 16 00 00 	mov    0x16a0(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
ps() {
  ...
  printf(1, "PID	TKTS	TCKS	STAT	NAME\n");
     f6c:	c7 44 24 04 b8 16 00 	movl   $0x16b8,0x4(%esp)
     f73:	00 
     f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f7b:	e8 7c 02 00 00       	call   11fc <printf>
  getpinfo(&pstat);
  ...
  while (pstat[i].pid != 0) {
    ...
    1028:	c7 44 24 04 d1 16 00 	movl   $0x16d1,0x4(%esp)
    102f:	00 
    1030:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1037:	e8 c0 01 00 00       	call   11fc <printf>
      i++;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    114c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    1153:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    1157:	74 17                	je     1170 <printint+0x2c>
    1159:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    115d:	79 11                	jns    1170 <printint+0x2c>
    neg = 1;
    115f:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    1166:	8b 45 0c             	mov    0xc(%ebp),%eax
    1169:	f7 d8                	neg    %eax
    116b:	89 45 ec             	mov    %eax,-0x14(%ebp)
    116e:	eb 06                	jmp    1176 <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    117d:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    1180:	8d 41 01             	lea    0x1(%ecx),%eax
    1183:	89 45 f4             	mov    %eax,-0xc(%ebp)
    1186:	8b 5d 10             	mov    0x10(%ebp),%ebx
    1189:	8b 45 ec             	mov    -0x14(%ebp),%eax
    118c:	ba 00 00 00 00       	mov    $0x0,%edx
    1191:	f7 f3                	div    %ebx
    1193:	89 d0                	mov    %edx,%eax
    1195:	0f b6 80 a6 1b 00 00 	movzbl 0x1ba6(%eax),%eax
    119c:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    11a0:	8b 75 10             	mov    0x10(%ebp),%esi
    11a3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    11a6:	ba 00 00 00 00       	mov    $0x0,%edx
    11ab:	f7 f6                	div    %esi
    11ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
    11b0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    11b4:	75 c7                	jne    117d <printint+0x39>
  if(neg)
    11b6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    11ba:	74 10                	je     11cc <printint+0x88>
    buf[i++] = '-';
    11bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11bf:	8d 50 01             	lea    0x1(%eax),%edx
    11c2:	89 55 f4             	mov    %edx,-0xc(%ebp)
    11c5:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    11ca:	eb 1f                	jmp    11eb <printint+0xa7>
    11cc:	eb 1d                	jmp    11eb <printint+0xa7>
    putc(fd, buf[i]);
    11ce:	8d 55 dc             	lea    -0x24(%ebp),%edx
    11d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11d4:	01 d0                	add    %edx,%eax
    11d6:	0f b6 00             	movzbl (%eax),%eax
    11d9:	0f be c0             	movsbl %al,%eax
    11dc:	89 44 24 04          	mov    %eax,0x4(%esp)
    11e0:	8b 45 08             	mov    0x8(%ebp),%eax
    11e3:	89 04 24             	mov    %eax,(%esp)
    11e6:	e8 31 ff ff ff       	call   111c <putc>
  while(--i >= 0)
    11eb:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    11ef:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    11f3:	79 d9                	jns    11ce <printint+0x8a>
}
    11f5:	83 c4 30             	add    $0x30,%esp
    11f8:	5b                   	pop    %ebx
    11f9:	5e                   	pop    %esi
    11fa:	5d                   	pop    %ebp
    11fb:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
    ...
    11ff:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    1202:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1209:	8d 45 0c             	lea    0xc(%ebp),%eax
    120c:	83 c0 04             	add    $0x4,%eax
    120f:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    1212:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1219:	e9 7c 01 00 00       	jmp    139a <printf+0x19e>
    c = fmt[i] & 0xff;
    ...
    122c:	25 ff 00 00 00       	and    $0xff,%eax
    1231:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1234:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1238:	75 2c                	jne    1266 <printf+0x6a>
      if(c == '%'){
    123a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    123e:	75 0c                	jne    124c <printf+0x50>
        state = '%';
    1240:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1247:	e9 4a 01 00 00       	jmp    1396 <printf+0x19a>
      } else {
        putc(fd, c);
    ...
    125c:	e8 bb fe ff ff       	call   111c <putc>
    1261:	e9 30 01 00 00       	jmp    1396 <printf+0x19a>
      }
    } else if(state == '%'){
    1266:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    126a:	0f 85 26 01 00 00    	jne    1396 <printf+0x19a>
      if(c == 'd'){
    1270:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1274:	75 2d                	jne    12a3 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    1276:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1279:	8b 00                	mov    (%eax),%eax
    127b:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    1282:	00 
    1283:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    128a:	00 
    128b:	89 44 24 04          	mov    %eax,0x4(%esp)
    128f:	8b 45 08             	mov    0x8(%ebp),%eax
    1292:	89 04 24             	mov    %eax,(%esp)
    1295:	e8 aa fe ff ff       	call   1144 <printint>
        ap++;
    129a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    129e:	e9 ec 00 00 00       	jmp    138f <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    12a3:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    12a7:	74 06                	je     12af <printf+0xb3>
    12a9:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    12ad:	75 2d                	jne    12dc <printf+0xe0>
        printint(fd, *ap, 16, 0);
    12af:	8b 45 e8             	mov    -0x18(%ebp),%eax
    12b2:	8b 00                	mov    (%eax),%eax
    12b4:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    12bb:	00 
    12bc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    12c3:	00 
    12c4:	89 44 24 04          	mov    %eax,0x4(%esp)
    12c8:	8b 45 08             	mov    0x8(%ebp),%eax
    12cb:	89 04 24             	mov    %eax,(%esp)
    12ce:	e8 71 fe ff ff       	call   1144 <printint>
        ap++;
    12d3:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    12d7:	e9 b3 00 00 00       	jmp    138f <printf+0x193>
      } else if(c == 's'){
    12dc:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    12e0:	75 45                	jne    1327 <printf+0x12b>
        s = (char*)*ap;
    12e2:	8b 45 e8             	mov    -0x18(%ebp),%eax
    12e5:	8b 00                	mov    (%eax),%eax
    12e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    12ea:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    12ee:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    12f2:	75 09                	jne    12fd <printf+0x101>
          s = "(null)";
    12f4:	c7 45 f4 e1 16 00 00 	movl   $0x16e1,-0xc(%ebp)
        while(*s != 0){
    12fb:	eb 1e                	jmp    131b <printf+0x11f>
    12fd:	eb 1c                	jmp    131b <printf+0x11f>
          putc(fd, *s);
    ...
    1312:	e8 05 fe ff ff       	call   111c <putc>
          s++;
    1317:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    131b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    131e:	0f b6 00             	movzbl (%eax),%eax
    1321:	84 c0                	test   %al,%al
    1323:	75 da                	jne    12ff <printf+0x103>
    1325:	eb 68                	jmp    138f <printf+0x193>
        }
      } else if(c == 'c'){
    1327:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    132b:	75 1d                	jne    134a <printf+0x14e>
        putc(fd, *ap);
    132d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1330:	8b 00                	mov    (%eax),%eax
    1332:	0f be c0             	movsbl %al,%eax
    1335:	89 44 24 04          	mov    %eax,0x4(%esp)
    1339:	8b 45 08             	mov    0x8(%ebp),%eax
    133c:	89 04 24             	mov    %eax,(%esp)
    133f:	e8 d8 fd ff ff       	call   111c <putc>
        ap++;
    1344:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1348:	eb 45                	jmp    138f <printf+0x193>
      } else if(c == '%'){
    134a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    134e:	75 17                	jne    1367 <printf+0x16b>
        putc(fd, c);
    1350:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1353:	0f be c0             	movsbl %al,%eax
    1356:	89 44 24 04          	mov    %eax,0x4(%esp)
    135a:	8b 45 08             	mov    0x8(%ebp),%eax
    135d:	89 04 24             	mov    %eax,(%esp)
    1360:	e8 b7 fd ff ff       	call   111c <putc>
    1365:	eb 28                	jmp    138f <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1367:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    136e:	00 
    136f:	8b 45 08             	mov    0x8(%ebp),%eax
    1372:	89 04 24             	mov    %eax,(%esp)
    1375:	e8 a2 fd ff ff       	call   111c <putc>
        putc(fd, c);
    137a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    137d:	0f be c0             	movsbl %al,%eax
    1380:	89 44 24 04          	mov    %eax,0x4(%esp)
    1384:	8b 45 08             	mov    0x8(%ebp),%eax
    1387:	89 04 24             	mov    %eax,(%esp)
    138a:	e8 8d fd ff ff       	call   111c <putc>
      }
      state = 0;
    138f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    1396:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    139a:	8b 55 0c             	mov    0xc(%ebp),%edx
    139d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13a0:	01 d0                	add    %edx,%eax
    13a2:	0f b6 00             	movzbl (%eax),%eax
    13a5:	84 c0                	test   %al,%al
    13a7:	0f 85 71 fe ff ff    	jne    121e <printf+0x22>
    }
  }
}
    13ad:	c9                   	leave  
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    ...
    13b8:	83 e8 08             	sub    $0x8,%eax
    13bb:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    13be:	a1 2c 1c 00 00       	mov    0x1c2c,%eax
    13c3:	89 45 fc             	mov    %eax,-0x4(%ebp)
    13c6:	eb 24                	jmp    13ec <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    13c8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13cb:	8b 00                	mov    (%eax),%eax
    13cd:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    13d0:	77 12                	ja     13e4 <free+0x35>
    13d2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13d5:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    13d8:	77 24                	ja     13fe <free+0x4f>
    13da:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13dd:	8b 00                	mov    (%eax),%eax
    13df:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    13e2:	77 1a                	ja     13fe <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    13e4:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13e7:	8b 00                	mov    (%eax),%eax
    13e9:	89 45 fc             	mov    %eax,-0x4(%ebp)
    13ec:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13ef:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    13f2:	76 d4                	jbe    13c8 <free+0x19>
    13f4:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13f7:	8b 00                	mov    (%eax),%eax
    13f9:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    13fc:	76 ca                	jbe    13c8 <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    13fe:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1401:	8b 40 04             	mov    0x4(%eax),%eax
    1404:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    140b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    140e:	01 c2                	add    %eax,%edx
    1410:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1413:	8b 00                	mov    (%eax),%eax
    1415:	39 c2                	cmp    %eax,%edx
    1417:	75 24                	jne    143d <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    1419:	8b 45 f8             	mov    -0x8(%ebp),%eax
    141c:	8b 50 04             	mov    0x4(%eax),%edx
    141f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1422:	8b 00                	mov    (%eax),%eax
    1424:	8b 40 04             	mov    0x4(%eax),%eax
    1427:	01 c2                	add    %eax,%edx
    1429:	8b 45 f8             	mov    -0x8(%ebp),%eax
    142c:	89 50 04             	mov    %edx,0x4(%eax)
...
morecore(uint nu)
{
    ...
    1493:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    1496:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    149d:	77 07                	ja     14a6 <morecore+0x16>
    nu = 4096;
    149f:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    14a6:	8b 45 08             	mov    0x8(%ebp),%eax
    14a9:	c1 e0 03             	shl    $0x3,%eax
    14ac:	89 04 24             	mov    %eax,(%esp)
    14af:	e8 48 fc ff ff       	call   10fc <sbrk>
    14b4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    14b7:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    14bb:	75 07                	jne    14c4 <morecore+0x34>
    return 0;
    14bd:	b8 00 00 00 00       	mov    $0x0,%eax
    14c2:	eb 22                	jmp    14e6 <morecore+0x56>
  hp = (Header*)p;
    14c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14c7:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    14ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14cd:	8b 55 08             	mov    0x8(%ebp),%edx
    14d0:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    14d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14d6:	83 c0 08             	add    $0x8,%eax
    14d9:	89 04 24             	mov    %eax,(%esp)
    14dc:	e8 ce fe ff ff       	call   13af <free>
  return freep;
    14e1:	a1 2c 1c 00 00       	mov    0x1c2c,%eax
}
    14e6:	c9                   	leave  
    14e7:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    14f1:	83 c0 07             	add    $0x7,%eax
    14f4:	c1 e8 03             	shr    $0x3,%eax
    14f7:	83 c0 01             	add    $0x1,%eax
    14fa:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    14fd:	a1 2c 1c 00 00       	mov    0x1c2c,%eax
    1502:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1505:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1509:	75 23                	jne    152e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    150b:	c7 45 f0 24 1c 00 00 	movl   $0x1c24,-0x10(%ebp)
    1512:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1515:	a3 2c 1c 00 00       	mov    %eax,0x1c2c
    151a:	a1 2c 1c 00 00       	mov    0x1c2c,%eax
    151f:	a3 24 1c 00 00       	mov    %eax,0x1c24
    base.s.size = 0;
    1524:	c7 05 28 1c 00 00 00 	movl   $0x0,0x1c28
    152b:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    153c:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    153f:	72 4d                	jb     158e <malloc+0xa6>
      if(p->s.size == nunits)
    1541:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1544:	8b 40 04             	mov    0x4(%eax),%eax
    1547:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    154a:	75 0c                	jne    1558 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    154c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    154f:	8b 10                	mov    (%eax),%edx
    1551:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1554:	89 10                	mov    %edx,(%eax)
    1556:	eb 26                	jmp    157e <malloc+0x96>
      else {
        p->s.size -= nunits;
    1558:	8b 45 f4             	mov    -0xc(%ebp),%eax
    155b:	8b 40 04             	mov    0x4(%eax),%eax
    155e:	2b 45 ec             	sub    -0x14(%ebp),%eax
    1561:	89 c2                	mov    %eax,%edx
    1563:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1566:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    1569:	8b 45 f4             	mov    -0xc(%ebp),%eax
    156c:	8b 40 04             	mov    0x4(%eax),%eax
    156f:	c1 e0 03             	shl    $0x3,%eax
    1572:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    1575:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1578:	8b 55 ec             	mov    -0x14(%ebp),%edx
    157b:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    157e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1581:	a3 2c 1c 00 00       	mov    %eax,0x1c2c
      return (void*)(p + 1);
    1586:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1589:	83 c0 08             	add    $0x8,%eax
    158c:	eb 38                	jmp    15c6 <malloc+0xde>
    }
    if(p == freep)
    158e:	a1 2c 1c 00 00       	mov    0x1c2c,%eax
    1593:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    1596:	75 1b                	jne    15b3 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    1598:	8b 45 ec             	mov    -0x14(%ebp),%eax
    159b:	89 04 24             	mov    %eax,(%esp)
    159e:	e8 ed fe ff ff       	call   1490 <morecore>
    15a3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    15a6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    15aa:	75 07                	jne    15b3 <malloc+0xcb>
        return 0;
    15ac:	b8 00 00 00 00       	mov    $0x0,%eax
    15b1:	eb 13                	jmp    15c6 <malloc+0xde>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    15b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    15b6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    15b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    15bc:	8b 00                	mov    (%eax),%eax
    15be:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }
    15c1:	e9 70 ff ff ff       	jmp    1536 <malloc+0x4e>
}
    15c6:	c9                   	leave  
    15c7:	c3                   	ret    
