...
printf(int fd, const char *s, ...)
{
  ...
  22:	e8 89 04 00 00       	call   4b0 <write>
}
  27:	c9                   	leave  
  28:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 40 05 00 	movl   $0x540,0x4(%esp)
  36:	00 
  ...
  4a:	eb 1f                	jmp    6b <forktest+0x42>
    pid = fork();
  4c:	e8 37 04 00 00       	call   488 <fork>
  ...
  60:	75 05                	jne    67 <forktest+0x3e>
      exit();
  62:	e8 29 04 00 00       	call   490 <exit>
  for(n=0; n<N; n++){
  ...
  if(wait() != -1){
  cc:	e8 c7 03 00 00       	call   498 <wait>
  d1:	83 f8 ff             	cmp    $0xffffffff,%eax
  d4:	74 19                	je     ef <forktest+0xc6>
    printf(1, "wait got too many\n");
  d6:	c7 44 24 04 7f 05 00 	movl   $0x57f,0x4(%esp)
  dd:	00 
  de:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e5:	e8 16 ff ff ff       	call   0 <printf>
    exit();
  ea:	e8 a1 03 00 00       	call   490 <exit>
  }

  printf(1, "fork test OK\n");
  ef:	c7 44 24 04 92 05 00 	movl   $0x592,0x4(%esp)
  f6:	00 
...
main(void)
{
 ...
 10b:	e8 19 ff ff ff       	call   29 <forktest>
  exit();
 110:	e8 7b 03 00 00       	call   490 <exit>
...
gets(char *buf, int max)
{
 ...
 24c:	e8 57 02 00 00       	call   4a8 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 2b1:	e8 1a 02 00 00       	call   4d0 <open>
...
ps() {
 ...
 388:	c7 44 24 04 a0 05 00 	movl   $0x5a0,0x4(%esp)
 38f:	00 
 390:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 397:	e8 64 fc ff ff       	call   0 <printf>
  getpinfo(&pstat);
 39c:	8d 85 e4 f6 ff ff    	lea    -0x91c(%ebp),%eax
 3a2:	89 04 24             	mov    %eax,(%esp)
 3a5:	e8 86 01 00 00       	call   530 <getpinfo>
  while (pstat[i].pid != 0) {
 3aa:	e9 ad 00 00 00       	jmp    45c <ps+0xe7>
      printf(1, "%d	%d	%d	%c	%s\n", pstat[i].pid, 
	pstat[i].tickets, pstat[i].ticks, pstat[i].state, pstat[i].name);
 3af:	8d 8d e4 f6 ff ff    	lea    -0x91c(%ebp),%ecx
 3b5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 3b8:	89 d0                	mov    %edx,%eax
 3ba:	c1 e0 03             	shl    $0x3,%eax
 3bd:	01 d0                	add    %edx,%eax
 3bf:	c1 e0 02             	shl    $0x2,%eax
 3c2:	83 c0 10             	add    $0x10,%eax
 3c5:	8d 3c 01             	lea    (%ecx,%eax,1),%edi
 3c8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 3cb:	89 d0                	mov    %edx,%eax
 3cd:	c1 e0 03             	shl    $0x3,%eax
 3d0:	01 d0                	add    %edx,%eax
 3d2:	c1 e0 02             	shl    $0x2,%eax
 3d5:	8d 5d e8             	lea    -0x18(%ebp),%ebx
 3d8:	01 d8                	add    %ebx,%eax
 3da:	2d e4 08 00 00       	sub    $0x8e4,%eax
 3df:	0f b6 00             	movzbl (%eax),%eax
      printf(1, "%d	%d	%d	%c	%s\n", pstat[i].pid, 
 3e2:	0f be f0             	movsbl %al,%esi
 3e5:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 3e8:	89 d0                	mov    %edx,%eax
 3ea:	c1 e0 03             	shl    $0x3,%eax
 3ed:	01 d0                	add    %edx,%eax
 3ef:	c1 e0 02             	shl    $0x2,%eax
 3f2:	8d 4d e8             	lea    -0x18(%ebp),%ecx
 3f5:	01 c8                	add    %ecx,%eax
 3f7:	2d f8 08 00 00       	sub    $0x8f8,%eax
 3fc:	8b 18                	mov    (%eax),%ebx
 3fe:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 401:	89 d0                	mov    %edx,%eax
 403:	c1 e0 03             	shl    $0x3,%eax
 406:	01 d0                	add    %edx,%eax
 408:	c1 e0 02             	shl    $0x2,%eax
 40b:	8d 4d e8             	lea    -0x18(%ebp),%ecx
 40e:	01 c8                	add    %ecx,%eax
 410:	2d 00 09 00 00       	sub    $0x900,%eax
 415:	8b 08                	mov    (%eax),%ecx
 417:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 41a:	89 d0                	mov    %edx,%eax
 41c:	c1 e0 03             	shl    $0x3,%eax
 41f:	01 d0                	add    %edx,%eax
 421:	c1 e0 02             	shl    $0x2,%eax
 424:	8d 55 e8             	lea    -0x18(%ebp),%edx
 427:	01 d0                	add    %edx,%eax
 429:	2d fc 08 00 00       	sub    $0x8fc,%eax
 42e:	8b 00                	mov    (%eax),%eax
 430:	89 7c 24 18          	mov    %edi,0x18(%esp)
 434:	89 74 24 14          	mov    %esi,0x14(%esp)
 438:	89 5c 24 10          	mov    %ebx,0x10(%esp)
 43c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
 440:	89 44 24 08          	mov    %eax,0x8(%esp)
 444:	c7 44 24 04 b9 05 00 	movl   $0x5b9,0x4(%esp)
 44b:	00 
 44c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 453:	e8 a8 fb ff ff       	call   0 <printf>
      i++;
 458:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  while (pstat[i].pid != 0) {
 45c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 45f:	89 d0                	mov    %edx,%eax
 461:	c1 e0 03             	shl    $0x3,%eax
 464:	01 d0                	add    %edx,%eax
 466:	c1 e0 02             	shl    $0x2,%eax
 469:	8d 75 e8             	lea    -0x18(%ebp),%esi
 46c:	01 f0                	add    %esi,%eax
 46e:	2d fc 08 00 00       	sub    $0x8fc,%eax
 473:	8b 00                	mov    (%eax),%eax
 475:	85 c0                	test   %eax,%eax
 477:	0f 85 32 ff ff ff    	jne    3af <ps+0x3a>
  }
}
 47d:	81 c4 3c 09 00 00    	add    $0x93c,%esp
 483:	5b                   	pop    %ebx
 484:	5e                   	pop    %esi
 485:	5f                   	pop    %edi
 486:	5d                   	pop    %ebp
