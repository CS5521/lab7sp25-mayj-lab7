...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 7d 09 00 	movl   $0x97d,0x4(%esp)
  6d:	00 
...
ps() {
 ...
 302:	c7 44 24 04 99 09 00 	movl   $0x999,0x4(%esp)
 309:	00 
 ...
 3be:	c7 44 24 04 b2 09 00 	movl   $0x9b2,0x4(%esp)
 3c5:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 533:	0f b6 80 40 0c 00 00 	movzbl 0xc40(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 690:	75 09                	jne    69b <printf+0x101>
          s = "(null)";
 692:	c7 45 f4 c2 09 00 00 	movl   $0x9c2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 75c:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 ...
 827:	a3 5c 0c 00 00       	mov    %eax,0xc5c
}
 82c:	c9                   	leave  
 82d:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 87a:	e8 ce fe ff ff       	call   74d <free>
  return freep;
 87f:	a1 5c 0c 00 00       	mov    0xc5c,%eax
}
 884:	c9                   	leave  
 885:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 898:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 89b:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 8a0:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8a3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8a7:	75 23                	jne    8cc <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8a9:	c7 45 f0 54 0c 00 00 	movl   $0xc54,-0x10(%ebp)
 8b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8b3:	a3 5c 0c 00 00       	mov    %eax,0xc5c
 8b8:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 8bd:	a3 54 0c 00 00       	mov    %eax,0xc54
    base.s.size = 0;
 8c2:	c7 05 58 0c 00 00 00 	movl   $0x0,0xc58
 8c9:	00 00 00 
  }
 ...
 91f:	a3 5c 0c 00 00       	mov    %eax,0xc5c
      return (void*)(p + 1);
 ...
 92a:	eb 38                	jmp    964 <malloc+0xde>
    ...
    if(p == freep)
 92c:	a1 5c 0c 00 00       	mov    0xc5c,%eax
